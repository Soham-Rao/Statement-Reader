...
class CreditWindow(BaseToplevel):
    ...
    def submit(self):
        ...
        parser = Parser()
        parser.credit()  # Calculate total credits
        self.result_text.delete("1.0", "end")
        self.result_text.insert("1.0", f"Total credited amounts: ₹{parser.total_credit}")
...
class DebitWindow(BaseToplevel):
    ...
    def submit(self):
        # Create an instance of the Parser class
        parser = Parser()
        parser.debit()  # Calculate total debits
        self.result_text.delete("1.0", "end")
        self.result_text.insert("1.0", f"Total debited amounts: ₹{parser.total_debit}")
